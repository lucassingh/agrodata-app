...
// Adaptado de React Bits (reactbits.dev/text-animations/blur-text): tag configurable,
// texto completo expuesto a lectores de pantalla y estático con prefers-reduced-motion.
